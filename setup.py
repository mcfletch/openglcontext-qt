...
if __name__ == "__main__":
    extraArguments = {
        ...
        "long_description": """PySide Context for the OpenGLContext rendering engine

Adds a PySide/PyQt4-based context to the OpenGLContext rendering engine
...
""",
    ...
    setup(
        ...
        version=version,
        description="PySide context for OpenGLContext",
